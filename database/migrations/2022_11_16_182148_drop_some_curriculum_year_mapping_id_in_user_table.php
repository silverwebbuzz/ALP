...
class DropSomeCurriculumYearMappingIdInUserTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        if (Schema::hasColumn(cn::USERS_TABLE_NAME, 'curriculum_year_mapping_id')){
        ...
        if (Schema::hasColumn(cn::USERS_TABLE_NAME, 'current_curriculum_year_id')){
            Schema::table(cn::USERS_TABLE_NAME, function($table) {
        ...
        if (Schema::hasColumn(cn::USERS_TABLE_NAME, 'current_curriculum_year_mapping_id')){
            Schema::table(cn::USERS_TABLE_NAME, function($table) {
    ...
    public function down()
    {
        Schema::table(cn::USERS_TABLE_NAME, function (Blueprint $table) {
            $table->after(cn::USERS_ID_COL, function($table){
                ...
                $table->foreign('current_curriculum_year_mapping_id')->references(cn::CURRICULUM_YEAR_ID_COL)->on(cn::CURRICULUM_YEAR_TABLE_NAME)->onDelete(cn::DB_ENGINE_ONDELETE_NAME);
            });
        });
    }
}
