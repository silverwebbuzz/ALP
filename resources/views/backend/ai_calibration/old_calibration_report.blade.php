...
<div class="ai-calibration-lvl-diff">
    ...
    <div>
        <label>Standard Deviation of {{$level}}-level Difficulty</label>
...
<div class="calibration-report-option mt-5">
    ...
    <p class="mt-3 mb-2">You want to Copy the Median Difficulty of the corresponding Difficulty Level to Not Included Question Seeds</p>
    <div class="form-check">
        ...
        <label class="form-check-label" for="isUpdateNonIncludedQuestions1">Yes</label>
    </div>
    <div class="form-check">
        ...
        <label class="form-check-label" for="isUpdateNonIncludedQuestions2">No</label>
    </div>
    <label id="isUpdateNonIncludedQuestionsError" style="display:none;color: red;">Please select option</label>
</div>