                                     ...
                                     @if(!empty($SelfLearningTestList))
                                        ...
                                        <tr>
                                            ...
                                            <td class="btn-edit">
                                                ...
                                                <a href="javascript:void(0);" class="self-learning-exam_questions-info ml-2" data-examid="{{$selflearningTest->exam_id}}" data-studentid="{{$selflearningTest->user->id}}" title="{{__('languages.preview')}}"><i class="fa fa-book fa-lg" aria-hidden="true"></i></a>
...
<script>
    ...
    $(function() {    
        ...
        /* 
        * USE : In modal show Question Analysis
        */
        $(document).on('click', '.question_graph', function(e) {
            ...
            // Add for in backgond in blur this modal.
