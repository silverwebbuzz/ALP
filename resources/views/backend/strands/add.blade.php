            ...
            <div class="sm-right-detail-sec pl-5 pr-5">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="sec-title">
								<h2 class="mb-4 main-title">{{__('languages.strands_management.add_new_strand')}}</h2>
							</div>
                            <div class="sec-title">
					...
					<div class="sm-add-user-sec card">
                        ...
                        @endif
							...
							<form class="user-form" method="post" id="addStrandsForm"  action="{{ route('strands.store') }}">
							@csrf()
                                ...
                                <div class="form-row select-data">
                                    ...
                                    <label class="text-bold-600" for="exampleInputUsername1">{{ __('languages.code') }}</label>
                                        <input type="text" class="form-control" name="code" id="strand_code" placeholder="{{ __('languages.code') }}" value="{{old('strand_code')}}">
