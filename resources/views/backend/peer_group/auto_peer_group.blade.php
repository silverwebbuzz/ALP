    ...
    @section('content')
                            ...
                            <form method="POST" name="createAutoPeerGroupForm" id="createAutoPeerGroupForm">
                                ...
                                <div class="form-row">
                                    <div class="form-grade-section">
                                        ...
                                        <div class="form-group student_peer_group_section mt-3 row">
                                            <div class="student_peer_group_heading col-lg-3">
                                                <label>{{ __('languages.select_owner') }}</label>
                                            </div>
                                            <div class="col-lg-3">
                                                <select class="selectpicker form-control" data-show-subtext="true" data-live-search="true" name="group_creator_user" id="group_creator_user">
                                                    <option value="">{{ __('languages.select_owner') }}</option>
                                                    @if(isset($CreatorUserList) && !empty($CreatorUserList))
                                                    @foreach($CreatorUserList as $CreatorUser)
                                                    <option value="{{$CreatorUser->id}}" @if(Auth::user()->id == $CreatorUser->id) selected @endif>
                                                        @if(app()->getLocale() == 'en')
        ...
        <script>
            ...
            $(document).ready(function(){
                $("#auto-peer-group-student-id").multiselect({
                    enableHTML: true,
                    templates: {
