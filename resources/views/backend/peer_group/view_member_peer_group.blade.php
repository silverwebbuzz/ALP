			...
			<div class="sm-right-detail-sec pl-5 pr-5">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="sec-title">
								<h2 class="mb-4 main-title">{{__('languages.view_peer_group_members')}}</h2>
								<div class="btn-sec">
							...
							<div class="row peer-group-detail-sec">
								...
								<div class="col-md-3">
									<span><b>{{__('languages.owner')}} </b>: </span>
									<span>
										@if(app()->getLocale() == 'en')
								...
								<table id="view-peer-group-member-table" class="display" style="width:100%">
									...
									<tbody class="scroll-pane">
										...
										<tr>
											...
											@if(auth()->user()->role_id != 3)
												<td>{{$Member->CreditPoints ?? 0}}</td>
												<td><a href="{{route('student-profiles',$Member->member->id)}}" title="{{__('languages.my_class.view_profile')}}"><i class="fa fa-eye fa-lg" aria-hidden="true"></i></a></td>
											@endif
										</tr>
										@endforeach
										@endif
