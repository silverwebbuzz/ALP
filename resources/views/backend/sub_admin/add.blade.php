            ...
            <div class="sm-right-detail-sec pl-5 pr-5">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="sec-title">
								<h2 class="mb-4 main-title">{{__('languages.sub_admin_management.add_new_sub_admin')}}</h2>
							</div>
                            <div class="sec-title">
					...
					<div class="sm-add-user-sec card">
                        <div class="select-option-sec pb-5 card-body">
                            ...
                            @endif
                            <form class="user-form" method="post" id="addSubAdminForm"  action="{{ route('sub-admin.store') }}">
                                @csrf()
