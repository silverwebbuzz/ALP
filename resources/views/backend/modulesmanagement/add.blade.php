            ...
            <div class="sm-right-detail-sec pl-5 pr-5">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="sec-title">
								<h2 class="mb-4 main-title">{{__('languages.module_management.add_new_module')}}</h2>
							</div>
                            <div class="sec-title">
					...
					<div class="sm-add-user-sec card">
                        ...
                        @endif
							...
							<form class="user-form" method="post" id="addModulesForm"  action="{{ route('modulesmanagement.store') }}">
							@csrf()
                                <div class="form-row select-data">
                                    <div class="form-group col-md-6">
                                        <label class="text-bold-600" for="exampleInputUsername1">{{ __('languages.module_management.module_name') }}</label>
                                        <input type="text" class="form-control" name="module_name" id="module_name" placeholder="{{__('languages.module_management.module_name')}}" value="{{old('module_name')}}">
