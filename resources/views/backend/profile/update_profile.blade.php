            ...
            <div class="sm-right-detail-sec pl-5 pr-5">
				<div class="container-fluid">
					...
					<div class="sm-add-user-sec card">
                        ...
                        <form class="user-form" method="post" id="updateProfileForm"  action="{{ route('save-updated-profile',$user->id) }}" enctype="multipart/form-data">
							@csrf()
                            @method('patch')
                                    ...
                                    <div class="form-group col-md-6 mb-50">
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            <li class="d-inline-block mt-1 mr-1 mb-1">
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" name="is_school_admin_privilege_access" id="yes" value="yes" @if($user->is_school_admin_privilege_access == 'yes') checked @endif @if($user->role_id != 7) disabled @endif>
                                            ...
                                            <li class="d-inline-block my-1 mr-1 mb-1">
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" name="is_school_admin_privilege_access" id="no" value="no" @if($user->is_school_admin_privilege_access == 'no') checked @endif  @if($user->role_id != 7) disabled @endif>
