@extends('backend.layouts.app')
    ...
    <div class="wrapper d-flex align-items-stretch sm-deskbord-main-sec">
							        	...
							        	<tr>
											...
											@if(!App\Helpers\Helper::isExternalUserLogin())
												<td class="btn-edit">
													...
													<a href="javascript:void(0);" class="pl-2 QuestionsInExam"  data-id="{{$Question->id}}" title="{{__('languages.percentage_of_questions_in_exam')}}">
		...
		<script>
			$(document).on("click",".QuestionsInExam",function(){
				$questionId = $(this).data('id');
				QuestionPercentageInExam($questionId);
			});
		</script>
