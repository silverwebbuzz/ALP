                        ...
                        <div class="row result-statistics">
                            <div class="sm-que-option pl-3">
                                ...
                                <div class="row">
                                    ...
                                    @if(($ExamData->exam_type != 1 && Auth::user()->role_id == 2) || Auth::user()->role_id == 5 || Auth::user()->role_id == 7 || Auth::user()->role_id == 8)
                                        @if((Auth::check() && Auth::user()->role_id == 5) || (Auth::check() && Auth::user()->role_id == 7) || (Auth::check() && Auth::user()->role_id == 2) || (Auth::check() && Auth::user()->role_id == 8))
                                            @php $my_school='col-md-4'; @endphp
                                            @if(Auth::check() && Auth::user()->role_id == 5 || Auth::check() && Auth::user()->role_id == 7 || Auth::check() && Auth::user()->role_id == 8)
                                                @if($ExamData->exam_type == 1)
                                    ...
                                    @php
                                        ...
                                        if(Auth::check() && Auth::user()->role_id == 1){
                                            $all_school='col-md-12';
                                        }else if(Auth::check() && Auth::user()->role_id == 5 || Auth::check() && Auth::user()->role_id == 7 || Auth::check() && Auth::user()->role_id == 8){
                                            $all_school='col-md-6';
                                        }
                                    @endphp
                                    @if($ExamData->exam_type != 1 || Auth::check() && Auth::user()->role_id == 1)
