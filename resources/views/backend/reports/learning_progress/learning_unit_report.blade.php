                                                ...
                                                <tr>
													...
													<td>
														<div class="progress-bar-main">
															...
															<div class="progress" style="height:1rem;background-color:{{$ColorCodes['not_accomplished_color']}};" title="{{$LearningUnit['achieved_percentage']}}%">
																<div class="progress-bar p-1" data-toggle="tooltip" data-placement="top" title="{{$LearningUnit['achieved_percentage']}}%" style="width:{{$LearningUnit['achieved_percentage']}}%;background-color:{{$ColorCodes['accomplished_color']}};"></div>
															</div>
															<span class="progress-count">{{$LearningUnit['achieved_percentage']}}%</span>
															@else
