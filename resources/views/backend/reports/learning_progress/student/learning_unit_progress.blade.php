                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
															...
															@if(isset($progressReportArray[$studentId]['report_data'][$learninKey]) && !empty($progressReportArray[$studentId]['report_data'][$learninKey]['achieved_percentage']))
																<div class="progress" style="height:1rem;background-color:{{$ColorCodes['not_accomplished_color']}};" title="{{$progressReportArray[$studentId]['report_data'][$learninKey]['achieved_percentage']}}%">
																	<div class="progress-bar p-1" data-toggle="tooltip" data-placement="top" title="{{$progressReportArray[$studentId]['report_data'][$learninKey]['achieved_percentage']}}%" style="width:{{$progressReportArray[$studentId]['report_data'][$learninKey]['achieved_percentage']}}%;background-color:{{$ColorCodes['accomplished_color']}};"></div>
																</div>
																<span class="progress-count">{{$progressReportArray[$studentId]['report_data'][$learninKey]['achieved_percentage']}}%</span>
															@else
