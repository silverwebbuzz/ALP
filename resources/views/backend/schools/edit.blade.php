                            ...
                            @method('patch')
                                <div class="form-row select-data">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="school_name_en" id="school_name_en" placeholder="{{__('languages.school')}} {{ __('languages.name') }}" value="{{App\Helpers\Helper::decrypt($SchoolData->school_name_en)}}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="school_name_ch" id="school_name_ch" placeholder="{{__('languages.school')}} {{ __('languages.name') }} ({{__('languages.chinese')}})" value="{{App\Helpers\Helper::decrypt($SchoolData->school_name_ch)}}">
                                        ...
                                        <fieldset class="form-group">
                                            <select class="selectpicker form-control" data-show-subtext="true" data-live-search="true" name="region_id" id="region_id">
                                                @if(isset($Regions) && !empty($Regions))
                                                    ...
                                                    <option value="{{$region->id}}" @if(isset($SchoolData->region_id) && $SchoolData->region_id == $region->id) selected @endif><?php echo $region->{'region_'.app()->getLocale()}; ?></option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </fieldset>
                                ...
                                <div class="form-row select-data">
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control" name="address_en" id="address_en" placeholder="{{ __('languages.address') }}" value="" rows=5>{{($SchoolData->school_address_en) ? App\Helpers\Helper::decrypt($SchoolData->school_address_en) : ''}}</textarea>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control" name="address_ch" id="address_ch" placeholder="{{ __('languages.address')}} ({{__('languages.chinese')}})" value="" rows=5>{{($SchoolData->school_address_ch) ? App\Helpers\Helper::decrypt($SchoolData->school_address_ch) : ''}}</textarea>
                                ...
                                <div class="form-row select-data">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" placeholder="{{ __('languages.email_address') }}" value="{{$SchoolData->school_email}}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <fieldset class="form-group">
                                            <select class="selectpicker form-control" data-show-subtext="true" data-live-search="true" name="status" id="status">
                                                ...
                                                <option value="active" {{($SchoolData->status === "active") ? 'selected' : ''}}>{{__('languages.active')}}</option>
                                                <option value="inactive" {{($SchoolData->status === "inactive") ? 'selected' : ''}}>{{__('languages.inactive')}}</option>
                                            </select>
                                        </fieldset>
                                        <span id="error-status"></span>
