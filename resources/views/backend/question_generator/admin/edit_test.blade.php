                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 mb-50">
                                            ...
                                            <select name="use_of_modes" class="form-control select-option" id="use_of_modes" disabled="disabled">
                                                ...
                                                <option value="2" @if($exam->use_of_mode == 2) selected @endif>{{__('languages.challenge_exercise_template')}}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6 mb-50">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control end-date-picker" name="end_date" value="{{ date('d/m/Y', strtotime($exam->to_date)) }}" placeholder="{{$EndDateLabelText}}" autocomplete="off">
                                                <div class="input-group-addon input-group-append">
                                                    <div class="input-group-text">
                                                        <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
                                                    </div>
