                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 mb-50">
                                            ...
                                            <select name="use_of_modes" class="form-control select-option" id="use_of_modes">
                                                ...
                                                <option value="2" @if(request()->get('type') == 2) selected @endif>{{__('languages.question_generators_menu.as_a_collection_of_questions')}}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6 mb-50">
                                            ...
                                            <div class="input-group date">
                                                <input type="text" class="form-control date-picker" name="start_date" value="{{date('d/m/Y')}}" placeholder="{{__('languages.question_generators_menu.select_start_date')}}" autocomplete="off">
                                        ...
                                        <div class="form-group col-md-6 mb-50">
                                            ...
                                            <div class="input-group date">
                                                <input type="text" class="form-control end-date-picker" name="end_date" value="{{date('d/m/Y',strtotime("+1 days"))}}" placeholder="{{ __('languages.question_generators_menu.select_end_date') }}" autocomplete="off">
                                                <div class="input-group-addon input-group-append">
                                                    <div class="input-group-text">
                                                        <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
                                                    </div>
