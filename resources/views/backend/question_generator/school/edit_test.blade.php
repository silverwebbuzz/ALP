    ...
    <div id="content" class="pl-2 pb-5">
        ...
        <div class="sm-right-detail-sec pl-5 pr-5">
            <div class="container-fluid">
                ...
                @endphp
                <form name="question-generator" id="question-generator" action="{{ route('school.generate-questions-edit',$exam->id) }}" method="POST" onsubmit="ShowLoader();">
                    @csrf
                            ...
                            <div id="wizard">
                                ...
                                <section class="form-steps step1">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6 mb-50">
                                            @php
                                                $EndDateLabelText = ($exam->use_of_mode != 2) ? __('languages.question_generators_menu.end_date') : __('languages.deadline');
                                            @endphp
                                            <label>{{ $EndDateLabelText }}</label>
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control end-date-picker" name="end_date" value="{{ date('d/m/Y', strtotime($exam->to_date)) }}" placeholder="{{$EndDateLabelText}}" autocomplete="off" {{ $fieldDisabled }} >
                                                <div class="input-group-addon input-group-append">
                                                    <div class="input-group-text">
                                                        <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
                                                    </div>
                                        ...
                                        @php
                                            ...
                                            $questionTabDataList.='<div class="tab-pane fade '.$tab_active_contact.'" id="pills-contact-'.$qIndex.'" role="tabpanel" aria-labelledby="pills-contact-tab-'.$qIndex.'">
                                                ...
                                                <div class="question-content pl-2">
                                                    <div class="row">
                                                        <div class="col-md-6"><b>'.__('languages.strand').'</b> : <span class="q-strand-name" data-q-strand-id="'.$questionData['objective_mapping']['strand_id'].'">'.$questionData['objective_mapping']['strandName'].'</span></div>
                                                        <div class="col-md-6"><b>'.__('languages.learning_unit').'</b> : <span class="q-learning-units-name" data-q-learning-units-id="'.$questionData['objective_mapping']['learning_unit_id'].'">'.$questionData['objective_mapping']['learningUnitsName'].'</span></div>
                                                        <div class="col-md-6"><b>'.__('languages.learning_objective').'</b> : <span class="q-learning-objectives-title" data-q-learning-objectives-id="'.$questionData['objective_mapping']['learning_objectives_id'].'">'.$questionData['objective_mapping']['learningObjectivesTitle'].'</span></div>
