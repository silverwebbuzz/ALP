						...
						<div class="col-md-12">
							<div class="sec-title">
                                @if(isset($isSelfLearningExam) && $isSelfLearningExam == true && isset($isSelfLearningExercise) && $isSelfLearningExercise == true)
                                    <a href="{{route('student.self-learning-exercise',Auth::user()->id)}}" class="btn-back" >{{__('languages.back')}}</a>
                                @elseif(isset($isSelfLearningExam) && $isSelfLearningExam == true && isset($isSelfLearningTestingZone) && $isSelfLearningTestingZone == true)
                                    <a href="{{route('student.testing-zone',Auth::user()->id)}}" class="btn-back" >{{__('languages.back')}}</a>
                                @elseif(isset($isExerciseExam) && $isExerciseExam == true)
                                    <a href="{{route('getStudentExerciseExamList',Auth::user()->id)}}" class="btn-back" >{{__('languages.back')}}</a>
                                @elseif(isset($isTestExam) && $isTestExam == true)
                                    <a href="{{route('getStudentTestExamList',Auth::user()->id)}}" class="btn-back" >{{__('languages.back')}}</a>
                                @endif
							</div>
							<hr class="blue-line">
						</div>
