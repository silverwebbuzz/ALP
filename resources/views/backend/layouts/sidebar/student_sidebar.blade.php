...
@if(Auth::user()->role_id == 3)
    <nav id="sidebar" class="@if(!empty(Session::get('sidebar'))){{Session::get('sidebar')}}@endif" style="background-color:{{$RoleBasedColor['background_color']}};">
        ...
        <ul class="list-unstyled components mb-5">
            <li class="{{ (request()->is('student/dashboard') || request()->is('dashboard')) ? 'active' : ''}}">
                    ...
                    <ul class="flex-column pl-2 nav">
                        @if (in_array('exam_management_read', $permissions))
                            <li class="nav-item {{ (
                                    ...
                                    request()->is('student/create/self-learning-exercise')) 
                                ? 'active': ''  }}">
                                <a href="{{ route('student.self-learning-exercise',Auth::user()->id) }}">
                                    <div class="sidebar_icon_main">
                        ...
                        @if(in_array('my_classes_read', $permissions))
                            <li class="nav-item {{ (
                                    ...
                                    ? 'active': '' }}">
                                <a href="{{ route('getStudentExerciseExamList',Auth::user()->id) }}">
                                    <div class="sidebar_icon_main">
                        ...
                        @if(in_array('peer_group_read', $permissions))
                            <li class="nav-item {{ (
                                ...
                                <a href="{{ route('getStudentTestExamList',Auth::user()->id) }}">
                                    <div class="sidebar_icon_main">
                        ...
                        <li class="nav-item {{ (
                            ...
                            <a href="{{ route('student.testing-zone',Auth::user()->id) }}">
                                <div class="sidebar_icon_main">
