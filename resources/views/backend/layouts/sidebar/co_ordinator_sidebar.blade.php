        ...
        <ul class="list-unstyled components mb-5">
            ...
            <li class="nav-item">
                @if (in_array('my_account_read', $permissions))
                    ...
                    <div class="collapse {{ (request()->is('change-password')) ? 'show': '' }}" id="myaccount" aria-expanded="false">
            ...
            @if (in_array('reports_read', $permissions))
                <li class="nav-item">
                    ...
                    || request()->is('teacher/progress-report/learning-units') || request()->is('principal/progress-report/learning-objective') ||  request()->is('principal/progress-report/learning-units')
