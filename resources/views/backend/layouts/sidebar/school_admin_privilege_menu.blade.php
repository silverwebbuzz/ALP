...
<li class="nav-item">
    <a class="nav-link text-truncate 
        {{ (request()->is('school-users') || request()->is('school-users/*') || 
            ...
            request()->is('user/activity-log/*') ||
            request()->is('annual-credit-point')
    ...
    <div class="collapse 
        ...
        <ul class="flex-column pl-2 nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse {{ (request()->is('annual-credit-point')) ? 'show': '' }}" id="school_management_config" aria-expanded="false">
                    <ul class="flex-column pl-2 nav">
                        <li class="nav-item">
                        ...
                        <li class="nav-item {{ (request()->is('annual-credit-point')) ? 'active': '' }}">
                            <a class="nav-link" href="{{route('annual-credit-point')}}">
                                <div class="sidebar_icon_main">
