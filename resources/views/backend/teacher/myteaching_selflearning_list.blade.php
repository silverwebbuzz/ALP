										...
										<tbody class="scroll-pane">
											@if(isset($ExamsData['excercise_list']) && !empty($ExamsData['excercise_list']))
												@foreach($ExamsData['excercise_list'] as $grades_class => $selfLearningExcercise)
													@php $selfLearningExcerciseLists = $selfLearningExcercise->toArray(); @endphp
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form class="student-generate-test-form" method="get" id="student-generate-test-form">
				<div class="modal-header">
					<h4 class="modal-title w-100">{{__('languages.generate_self_learning')}} {{__('languages.exercise')}} & {{__('languages.generate_self_learning')}} {{__('languages.test_text')}}</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				</div>
				<div class="modal-body">
