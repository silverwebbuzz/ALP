						...
						<div class="col-md-12">
							<div class="sec-title">
								<h2 class="mb-4 main-title">
									{{__('languages.my_class.student_details')}} 
									@if(auth::user()->role_id != 3)
										({{$profile->class_student_number}})
									@endif
								</h2>
							</div>
							<div class="sec-title">
							...
							<div class="col-md-10">
								<div class="profile-detail">
									<div class="personal_details_main create_line">
										<h5>{{__('languages.my_class.personal_details') }} 
											@if(Auth::user()->role_id==3)
											<a href="{{route('profile.index')}}"><span class="fa fa-pencil"></span></a>
											@endif
										</h5>
										...
										<div class="detail-sec">
											...
											<p class="detail-p"> {{ (!empty($profile->CurriculumYearData->class_student_number)) ? $profile->CurriculumYearData->class_student_number : ''}}  </p>
										</div>
										<div class="detail-sec">
