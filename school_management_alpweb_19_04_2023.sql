...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 21, 2023 at 10:54 AM
...
--
-- Database: `school_management_alpweb_19_04_2023`
--
...
CREATE TABLE IF NOT EXISTS `peer_group` (
  ...
  `group_type` enum('peer_group','group') COLLATE utf8mb4_unicode_ci DEFAULT 'peer_group',
...
--
-- Table structure for table `used_question_answer_count`
--

DROP TABLE IF EXISTS `used_question_answer_count`;
CREATE TABLE IF NOT EXISTS `used_question_answer_count` (
  `question_id` bigint(20) UNSIGNED DEFAULT NULL,
  `question_count` int(11) DEFAULT '0',
  `answer_1` int(11) DEFAULT '0',
  `answer_2` int(11) DEFAULT '0',
  `answer_3` int(11) DEFAULT '0',
  `answer_4` int(11) DEFAULT '0',
  `answer_5` int(11) DEFAULT '0',
  KEY `used_question_answer_count_question_id_foreign` (`question_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Constraints for table `used_question_answer_count`
--
ALTER TABLE `used_question_answer_count`
  ADD CONSTRAINT `used_question_answer_count_question_id_foreign` FOREIGN KEY (`question_id`) REFERENCES `question` (`id`) ON DELETE CASCADE;
