...
class PeerGroupController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $schoolUsers = User::whereIn(cn::USERS_ROLE_ID_COL,[
                                cn::TEACHER_ROLE_ID,
        ...
        $PeerGroupQuery = PeerGroup::select('*')
                        ...
                        ->where(cn::PEER_GROUP_GROUP_TYPE_COL,'group');
        ...
        if(isset($request->filter)){
            ...
            if($request->creator){
                $Query->where(cn::PEER_GROUP_CREATED_BY_USER_ID_COL,$request->creator);
            }
        ...
        return view('backend.peer_group.peer_group_list',compact('items','PeerGroupList','SubjectList','schoolUsers'));
    }
