...
class QuestionController extends Controller
{
    ...
    public function store(Request $request){
        try{
            ...
            if($question){
                // Create new entry for Used question Answer Count
                UsedQuestionAnswerCount::Create([
                    cn::USED_QUESTION_ANSWER_QUESTION_ID_COL => $question->{cn::QUESTION_TABLE_ID_COL}
                ]);
                $StoreAnswerData = array(
                    cn::ANSWER_QUESTION_ID_COL          => $question->{cn::QUESTION_TABLE_ID_COL},
