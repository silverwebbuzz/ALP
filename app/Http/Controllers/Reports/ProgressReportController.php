...
class ProgressReportController extends Controller
{
    ...
    public function StudentProgressReportLearningUnits(Request $request,$studentId=0){
        try{
            ...
            return view('backend.reports.learning_progress.student.learning_unit_progress',compact('studentData','StrandList','LearningUnitsList','GradesList','grade_id','reportLearningType','progressReportArray','ColorCodes','studentId'));
        }catch(\Exception $exception){
            return back()->withError($exception->getMessage())->withInput();
        }
    }
