...
Route::get('abc', 'CommonController@abc')->name('abc');

/******************************************************************************************************************************
 *  Start Cron Job Urls **
 * ****************************************************************************************************************************/
Route::get('UpdateCountUsedQuestionAnswer', 'CronJobController@UpdateCountUsedQuestionAnswer')->name('UpdateCountUsedQuestionAnswer');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('question-percentage-in-exam','CommonController@getQuestionPercentageOfBasedOnAllUsedQuestionAnswerAllTest')->name('question-percentage-in-exam');
     ...
     * *********************************************************************************/
    Route::match(['GET', 'POST'],'student/exercise/exam/{id}', 'ExamController@getStudentExerciseExamList')->name('getStudentExerciseExamList');
    Route::match(['GET', 'POST'],'student/test/exam/{id}', 'ExamController@getStudentTestExamList')->name('getStudentTestExamList');
    ...
    Route::match(['GET', 'POST'],'student/self-learning/exercise/{id}','StudentController@getSelfLearningExerciseList')->name('student.self-learning-exercise');
    ...
    Route::match(['GET', 'POST'],'student/testing-zone/{id}','StudentController@getTestingZoneList')->name('student.testing-zone');
    ...
    * *********************************************************************************/
    ...
    /**
     * Annul Credit point for Admin and School Admin
     */
    Route::match(['Get','Post'],'annual-credit-point','CommonController@AnnualCreditPoint')->name('annual-credit-point');
    Route::match(['Get','Post'],'game-bundle','CommonController@AnnualCreditPoint')->name('game-bundle');
     ...
     *  Game Routes
     **********************************************************/
    Route::get('start-game','UsersController@game')->name('start-game');
    Route::get('play-game','UsersController@play_game')->name('play-game');
});