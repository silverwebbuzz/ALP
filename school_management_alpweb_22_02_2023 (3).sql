...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 24, 2023 at 04:57 AM
...
--
-- Database: `school_management_alpweb_22_02_2023`
--
...
CREATE TABLE IF NOT EXISTS `exam` (
  ...
  `created_by_user` enum('super_admin','school_admin','teacher','principal','student') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `history_student_exams` (
  ...
  `first_trial_wrong_question_ids` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `before_emoji_id` int(11) DEFAULT NULL,
  `after_emoji_id` int(11) DEFAULT NULL,
  `total_seconds` int(11) DEFAULT NULL,
  `first_trial_answered_flag_question_ids` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `first_trial_not_attempted_flag_question_ids` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `second_trial_answered_flag_question_ids` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `second_trial_not_attempted_flag_question_ids` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `history_student_question_answer` (
  ...
  `is_answered_flag` enum('true','false') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user_credit_point_history` (
  ...
  `exam_id` bigint(20) UNSIGNED DEFAULT NULL,
  `user_id` bigint(20) UNSIGNED DEFAULT NULL,
  `test_type` enum('assignment','self_learning') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `self_learning_type` enum('test','exercise') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `credit_point_type` enum('after_submission','accuracy_level','ability_level','manual_credit_point') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
