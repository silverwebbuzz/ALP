...
js.src = BASE_URL+"/wirislibeditor/ckeditor4/plugins/ckeditor_wiris/integration/WIRISplugins.js?viewer=image";
 ...
 */
 function imgSetTitle(preview_div) {
 	...
 	for (var i = 0; i < imgs.length; i++) {
		...
		//Added by manoj prajapati
		 //imgs[i].style = "height:100px !important;";
 	}
 }
