...
b[2].toLowerCase()),d[c]=e,"o"===b[1]&&E(a[e]))});a._hungarianMap=d}function P(a,b,c){a._hungarianMap||E(a);var d;l.each(b,function(e,h){d=a._hungarianMap[e];d===q||!c&&b[d]!==q||("o"===d.charAt(0)?(b[d]||(b[d]={}),l.extend(!0,b[d],b[e]),P(a[d],b[d],c)):b[d]=b[e])})}function ma(a){var b=u.defaults.oLanguage,c=b.sDecimal;c&&Xa(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&d&&NO_DATA_AVAILABLE_IN_TABLE===b.sEmptyTable&&X(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&d&&"Loading..."===b.sLoadingRecords&&
...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:FIRST,sLast:LAST,sNext:NEXT,sPrevious:PREVIOUS},sEmptyTable:NO_DATA_AVAILABLE_IN_TABLE,sInfo:SHOWING+" _START_ "+TO+" _END_ "+OF+" _TOTAL_ "+ENTRIES,sInfoEmpty:SHOWING+" 0 "+TO+" 0 "+OF+" 0 "+ENTRIES,sInfoFiltered:"("+FILTERED+" "+FROM+" _MAX_ "+TOTAL+" "+ENTRIES+")",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:SHOW+" _MENU_ "+ENTRIES,sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:SEARCH+":",sSearchPlaceholder:"",sUrl:"",sZeroRecords:NO_MATCHING_RECORDS_FOUND},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};E(u.defaults);u.defaults.column={aDataSort:null,
